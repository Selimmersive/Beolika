...
export interface ApiLegalLegal extends Schema.CollectionType {
  ...
  attributes: {
    legals: Attribute.Component<'legal.legals', true>;
...
export interface ApiProductDetailProductDetail extends Schema.CollectionType {
  ...
  attributes: {
    descriptions: Attribute.Component<'description.descriptions', true>;
...
export interface ApiProductFaqProductFaq extends Schema.CollectionType {
  ...
  attributes: {
    faqs: Attribute.Component<'faq.faqs', true>;
    category: Attribute.Relation<
...
export interface ApiProductListProductList extends Schema.CollectionType {
  ...
  attributes: {
    lists: Attribute.Component<'list.lists', true>;
    category: Attribute.Relation<
